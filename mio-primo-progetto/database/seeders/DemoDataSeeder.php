...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $pi = User::firstOrCreate(
            ...
            ['name' => 'Principal Investigator', 'password' => Hash::make('password')]
        );
        ...
        foreach ($projects as $project) {
            ...
            // 3 membri con ruoli coerenti (lowercase)
            $members = $users->random(3);
            foreach ($members as $m) {
                $role = collect(['project_manager','researcher','collaborator'])->random();
                $project->users()->syncWithoutDetaching([
            ...
            foreach ($pubs as $pub) {
                ...
                // (Opzionale) Allegato & commento su pubblicazione
            ...
            // Allegati & Commenti polimorfici su progetto
